...
class ledLocalizationFast(object):
    ...
    def fitPositionToVectors(self, vect_X, vect_Y, vect_Z, _LED_Indices):
        return _FastFireFly.ledLocalizationFast_fitPositionToVectors(self, vect_X, vect_Y, vect_Z, _LED_Indices)
